...
from src.infrastructure.repository.pgsql.text.rep_text_clean import (
    CleanTextRepository,
)
from src.infrastructure.repository.pgsql.text.rep_text_ngrams import (
    NGramizedTextRepository,
)
from src.infrastructure.repository.pgsql.text.rep_text_raw import (
    RawTextRepository,
)
from src.infrastructure.repository.pgsql.text.rep_text_split import (
    TextSentencesRepository,
)
from src.infrastructure.repository.pgsql.text.rep_text_tokenized import (
    TokenizedTextRepository,
)
from src.infrastructure.repository.pgsql.text.rep_text_translated import (
