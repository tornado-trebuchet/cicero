...
from src.interface.api.dtos.dto_common import CorporaSpecDTO, UUIDResponse, CorporaDTO
from src.interface.api.mappers.mp_common import dto_to_corpora_spec, corpora_to_dto
from src.application.use_cases.common.corpora import CorporaManger
from src.application.di.di_common import get_corpora_by_id_use_case
