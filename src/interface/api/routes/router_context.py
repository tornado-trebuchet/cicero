...
def list_parties(list_parties_use_case: Any = Depends(get_list_parties_use_case)) -> List[PartyDTO]:
...
def list_periods(list_periods_use_case: Any = Depends(get_list_periods_use_case)) -> List[PeriodDTO]:
