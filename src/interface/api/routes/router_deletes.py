...
# FIXME: Needs tweaking of the schema
# for now does not properly delete protocols,
...
def delete_protocol(
    protocol_id: str, use_case: Any = Depends(delete_protocol_use_case)
):
...
def delete_speech(
    speech_id: str, use_case: Any = Depends(delete_speech_use_case)
):
...
def delete_speech_text(
    speech_text_id: str, use_case: Any = Depends(delete_speech_text_use_case)
):
...
def delete_text_clean(
    clean_text_id: str, use_case: Any = Depends(delete_text_clean_use_case)
):
...
def delete_ngramized_text(
    ngramized_text_id: str,
    use_case: Any = Depends(delete_ngramized_text_use_case),
):
...
def delete_text_raw(
    raw_text_id: str, use_case: Any = Depends(delete_text_raw_use_case)
):
...
def delete_text_split(
    split_text_id: str, use_case: Any = Depends(delete_text_split_use_case)
):
...
def delete_tokenized_text(
    tokenized_text_id: str,
    use_case: Any = Depends(delete_tokenized_text_use_case),
):
...
def delete_translated_text(
    ...
    use_case: Any = Depends(delete_translated_text_use_case),
):
...
def delete_country(
    country_id: str, use_case: Any = Depends(delete_country_use_case)
):
...
def delete_institution(
    institution_id: str, use_case: Any = Depends(delete_institution_use_case)
):
...
def delete_party(
    party_id: str, use_case: Any = Depends(delete_party_use_case)
):
...
def delete_period(
    period_id: str, use_case: Any = Depends(delete_period_use_case)
):
...
def delete_speaker(
    speaker_id: str, use_case: Any = Depends(delete_speaker_use_case)
):
