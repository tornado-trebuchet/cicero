...
from src.interface.api.dtos.dto_service import ProtocolSpecDTO, ExtractionSpecDTO
from src.interface.api.mappers.mp_service import dto_to_protocol_spec, dto_to_extraction_spec
...
from src.application.modules.text_services.extractor.extractor import ExtractorService
...
def seed_fetch_extract(seed_defaults_use_case: SeedDefaultsUseCase = Depends(get_seed_defaults_use_case)):
    """
