...
class GermanStopwords(Stopwords):
    ...
    def general_stopwords(self) -> set[str]:
        return {
            "und", "oder", "aber", "nicht", "kein", "eine", "der", "die", "das", "ist", "in", "zu", "den", "von", "mit", "auf", "für", "an", "im", "es", "dem", "als", "auch", "am", "aus", "bei", "sich", "nach", "wie", "so", "wir", "er", "sie", "ich", "man", "noch", "nur", "schon", "wenn", "über", "dass", "wir", "was", "wird", "sind"
        }
