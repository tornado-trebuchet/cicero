...
class CorporaMapper:
    ...
    def to_orm(domain_entity: Corpora) -> CorporaORM:
        orm = CorporaORM(
            ...
            institutions=[uuid.value for uuid in domain_entity.institutions] if domain_entity.institutions else None,
    ...
    def to_domain(orm_entity: CorporaORM) -> Corpora:
        return Corpora(
            ...
            institutions=[UUID(iid) for iid in orm_entity.institutions] if orm_entity.institutions else None,
