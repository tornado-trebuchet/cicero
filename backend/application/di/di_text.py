from backend.application.use_cases.text.delete import (
...
from backend.application.use_cases.text.get_by import (
...
from backend.application.use_cases.text.list import ListProtocolsUseCase
from backend.infrastructure.repository.pgsql.text.rep_protocol import (
    ProtocolRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_speech import (
    SpeechRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_speech_text import (
    SpeechTextRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_text_clean import (
    CleanTextRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_text_ngrams import (
    NGramizedTextRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_text_raw import (
    RawTextRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_text_split import (
    TextSentencesRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_text_tokenized import (
    TokenizedTextRepository,
)
from backend.infrastructure.repository.pgsql.text.rep_text_translated import (
